    ...
    <div className="bg-violet-950">
      <div className="max-w-2xl mx-auto text-white py-10">
        <div className="text-center">
          ...
          <p className="line-clamp-3 mx-12">Your go-to resource for all things related to MonadPedia..</p>
          <div className="flex justify-center my-10">
            <div className="flex items-center border w-auto rounded-lg px-4 py-2 w-52 mx-2">
              ...
              <div className="text-left ml-3">
                <p className="text-xs text-gray-200">Follow us</p>
        ...
        <div className="mt-28 flex flex-col md:flex-row md:justify-between items-center text-sm text-gray-400">
          <p className="order-2 md:order-1 mt-8 md:mt-0">&copy; MonadPedia 2024.</p>
